<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pacientes.aspx.cs" Inherits="ClinicaWeb.admin.pacientes" MasterPageFile="~/admin/AdminMaster.master" %>
                    ...
                    <div class="tarjeta-gestion h-100 d-flex flex-column justify-content-between pb-3">
                        <div>
                            ...
                            <div class="tarjeta-contenido">
                                <h3 class="mb-3"><%# Eval("nombre") + " " + Eval("primerApellido") + " " + Eval("segundoApellido") %></h3>
                                <div class="detalle-item mb-2"><i class="fas fa-id-card"></i> <strong>Código:</strong> <%# Eval("docIdentidad") %></div>
                        ...
                        <div class="d-flex justify-content-center gap-2 mt-3">
                            <asp:Button runat="server"
                                ...
                                CommandName="VerHistoria"
                                CommandArgument='<%# Eval("docIdentidad") %>' />
                            <asp:Button runat="server"
