<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroUsuarioPaciente.aspx.cs" Inherits="ClinicaWeb.RegistroUsuarioPaciente" %>
            ...
            <div class="contenedor-formulario">
                ...
                <form class="formulario-login" runat="server">
                    <div class="grupo-formulario">
                        ...
                        <input type="text" id="txtUsername" name="txtUsername" runat="server" required placeholder="Ingresa tu usuario">
                    </div>
                    <div class="grupo-formulario">
                        ...
                        <div class="input-group">
                            <input type="password" id="txtPassword" name="txtPassword" runat="server" required placeholder="Ingresa tu contraseña">
                    ...
                    <div class="grupo-formulario">
                        ...
                        <div class="input-group">
                            <input type="password" id="txtConfirmPassword" name="txtConfirmPassword" runat="server" required placeholder="Confirma tu contraseña">
