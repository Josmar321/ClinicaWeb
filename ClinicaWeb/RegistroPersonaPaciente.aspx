<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroPersonalPaciente.aspx.cs" Inherits="ClinicaWeb.RegistroPersonaPaciente" %>
...
<head>
    ...
    <title>Registro de Persona - NeoSalud</title>
        ...
        <div class="registro-persona-card">
            <div class="registro-persona-header">
                ...
                <div class="registro-persona-title">
                    ...
                    <p>Complete sus datos personales para finalizar el registro</p>
                </div>
            </div>
            ...
            <div class="registro-persona-content">
                <form runat="server">
                    ...
                    <div class="form-actions">
                        ...
                        <asp:Button ID="btnGuardar" runat="server" CssClass="btn-save" Text="Completar Registro" OnClick="btnGuardar_Click" />
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                // Si hay algún error, simplemente lo ignoramos
                console.log('Error al inicializar file upload:', error);
            }
        });
    </script>
</body>
